...
String firstState;
List<String> lastStates = new ArrayList<>();
%}
...
<SYMT> {Symbol} {
    ...
    transitions.symbol.add(yycharat(0));
    yybegin(SEPSDT);
}
